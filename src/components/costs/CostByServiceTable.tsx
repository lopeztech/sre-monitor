      ...
      <table className="w-full text-sm">
        <thead>
          <tr className="border-b border-slate-800">
            <th className="pb-2 text-left text-xs font-medium text-slate-400">Service</th>
            <th className="pb-2 text-right text-xs font-medium text-slate-400">Current</th>
            <th className="pb-2 text-right text-xs font-medium text-slate-400">Previous</th>
            <th className="pb-2 text-right text-xs font-medium text-slate-400">Change</th>
          </tr>
        </thead>
          ...
          {sorted.map((svc) => {
            ...
            return (
              <tr key={svc.serviceId} className="group">
                <td className="py-2.5 text-slate-200 font-medium">{svc.serviceName}</td>
