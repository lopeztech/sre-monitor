      ...
      <CardContent className="pt-5">
        <div className="flex items-start gap-6">
          ...
          <div className="flex flex-col items-center gap-1">
            <div className="flex h-16 w-16 items-center justify-center rounded-full border-2 border-slate-700 bg-slate-800">
            ...
            <p className="text-xs font-medium text-slate-400">{scoreLabel(data.securityScore)}</p>
          </div>
                    ...
                    <div className="flex-1 rounded-full bg-slate-800 h-1.5">
                      <div
                        className={cn('h-1.5 rounded-full', {
                          ...
                          'bg-slate-500': severity === 'informational',
                        })}
